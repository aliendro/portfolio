const styles = {
  ...
  bigHeading: 'pl-4 text-6xl font-bold tracking-wider md:col-start-2',
  button: 'p-4 rounded-lg bg-green text-primary transition-all duration-200',
};

const Hero = () => (
  <section className={styles.section}>
    <h1 className={styles.heading}>&gt; Hi, my name is</h1>
    ...
    <h4 className="text-justify p-4 text-lg md:col-start-2">
      I&apos;m a software engineer with over 3 years of experience in building and implementing web
      applications. My main focus is delivering accessible, user-friendly, human-centered products.
    </h4>
    <div className="pl-4 md:col-start-2">
